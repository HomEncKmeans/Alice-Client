...
int main(){
    ...
    unsigned g=7;
    unsigned logQ=79; //4
    //KClient client(p,g,logQ,"../script/sample100x10.dat","127.0.0.1",5001,"127.0.0.1",5002);

    //KClientV1 client(p,g,logQ,"../script/sample100x10.dat","127.0.0.1",5001,"127.0.0.1",5002,true);
